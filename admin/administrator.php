...
<head>
    ...
    <style>
        <?php include 'admin_style/main.css'; ?><?php include 'admin_style/administrator.css'; ?>
    </style>
</head>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 d-flex justify-content-center">
                        <div id="formularz">
                            <form action="admin_pliki_serwerowe/admin_zaloguj.php" method="POST">
                                <div class="form-group">
                                    <label for="login">Login: </label>
                                    <input id="login" name="login" type="text" class="form-control" value="" required>
                                </div>
                                <div class="form-group">
