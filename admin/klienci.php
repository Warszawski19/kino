                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        echo ' <div class="row wiersz">
                                    <div class="col col-sm-10">
                                        <p>FILM: <span class="bold">'  . $row["Tytuł"] . '</span></p>
                                        <p>IMIE I NAZWISKO:  <span class="bold">' . $row["Imie i nazwisko"] . '</span></p>
                                        <p>NUMER TELEFONU: <span class="bold">'  . $row["Numer telefonu"] . '</span></p>
